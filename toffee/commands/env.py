...
class EnvCommands(BaseCommand):
    ...
    def create_environment(self, name: str) -> int:
        ...
        if success:
            ...
            error_console.print(
                f"[bold red]Error:[/] Failed to create environment '{name}'"
            )
            return 1
    ...
    def copy_environment(self, source: str, target: str) -> int:
        ...
        try:
            ...
            if os.path.isfile(source_env.vars_file):
                ...
                # Replace occurrences of source name with target name using word boundaries
            ...
            if os.path.isfile(source_env.backend_file):
                ...
                # Replace key in backend config - looking specifically for path patterns
