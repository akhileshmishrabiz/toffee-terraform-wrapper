...
class TerraformRunner:
    ...
    def build_command(self, command_name: str, env: Environment, extra_args: List[str] = None) -> List[str]:
        """
    ...
    def run_command(self, command_name: str, env: Environment, extra_args: List[str] = None) -> Tuple[int, str, str]:
        """
